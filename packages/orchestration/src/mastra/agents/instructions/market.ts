...
**市场快讯 market code**（供 data.get_market_news 使用）：
- A股 \`cn\`、美股 \`us\`、港股 \`hk\`、日股 \`jp\`、韩股 \`kr\`、澳股 \`au\`
- 印股 \`in\`、英股 \`uk\`、德股 \`de\`、法股 \`fr\`、加拿大 \`ca\`、巴西 \`br\`
- 全球市场 \`global\`、加密市场 \`crypto\`
- 除 A股专业快讯和 Crypto 专业 feed 外，股票市场返回代表性指数/ETF 新闻代理；
  必须根据响应 \`items[].symbols\` 与条目代理说明标注口径，不得称为完整市场新闻线
